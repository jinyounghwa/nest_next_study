          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/register" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                    회원가입
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/profile" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                    프로필
                  </Link>
                </li>
              </ul>
